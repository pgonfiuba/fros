...
def generate_launch_description():
    launch_dir = os.path.join(get_package_share_directory("clase1"), "launch")
    return LaunchDescription([
        ...
        LogInfo(msg=f"Usando mi launchfile del paquete de ROS de la clase 1 el directorio: {launch_dir}"),
    ])
